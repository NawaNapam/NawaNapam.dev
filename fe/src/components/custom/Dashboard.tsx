        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-15">
            ...
            <div className="space-y-6 md:flex md:gap-5 md:items-center md:justify-between lg:block mt-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-md bg-amber-500/20"><Users size={22} className="text-amber-400" /></div>
                  <div>
              ...
              <div className="flex items-center justify-between"> 
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-md bg-yellow-500/20"><Clock size={22} className="text-yellow-400" /></div>
                  <div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-md bg-rose-500/20"><Heart size={22} className="text-rose-400" /></div>
                  <div>
          ...
          <div className="bg-white/8 backdrop-blur-2xl rounded-xl p-8 shadow-2xl border border-amber-500/30">
            ...
            <div className="space-y-6">
              ...
              <button disabled={keywords.length === 0} className="w-full py-3.5 bg-amber-500/10 border border-amber-500/50 text-amber-300 font-bold rounded-lg hover:bg-amber-500/20 disabled:opacity-40 flex items-center justify-center gap-2 transition-all">
